...
export class UpdateJobPostingDto {
  @ApiProperty({ description: 'Título de la oferta', example: 'Desarrollador Backend Node.js', required: false })
  @IsOptional()
  @IsString()
  title?: string;
  ...
  @ApiProperty({
    ...
    example: 'Responsable del desarrollo de APIs con NestJS',
    required: false,
  })
  @IsOptional()
  @IsString()
  ...
  @ApiProperty({ description: 'Modalidad de trabajo', enum: WorkMode, required: false })
  @IsOptional()
  @IsEnum(WorkMode)
  work_mode?: WorkMode;

  @ApiProperty({ description: 'Tipo de tarifa', enum: RateType, required: false })
  @IsOptional()
  @IsEnum(RateType)
  rate_type?: RateType;
  ...
  @ApiProperty({ description: 'Moneda del presupuesto', enum: RateCurrency, required: false })
  @IsOptional()
  @IsEnum(RateCurrency)
